        ...
        <div className="flex flex-wrap justify-around box-border mx-2.5 my-6 ">
          {candles.map((candle) => (
            <div className="w-10/12 mb-20">
              ...
              <div className="mx-auto mt-6 mb-2 py-2 border-2 border-black cursor-pointer w-auto">
          ...
          <div className="mx-auto text-lg -mt-14 mb-4 py-2 cursor-pointer w-auto">
            <p className="text-center tracking-wider border-b border-black">Więcej produktów</p>
          </div>    
        </div>
      </Router>    
  );
