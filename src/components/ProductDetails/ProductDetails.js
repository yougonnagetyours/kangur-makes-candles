              ...
              <div className="">
                <div className="header sm:flex sm:mx-4 sm:justify-between">
                  <div className="border border-black sm:w-1/2">
                    <img className="" src={product.image.url} alt="candles" />
                  </div>
                  <div className="sm:flex justify-center sm:w-1/2">
                    <div className="sm:w-max">
                      <div className="mt-6 mb-2">
                        <p className="text-center text-base sm:text-lg tracking-widest">
                          {product.name}
                        </p>
                      </div>
                      ...
                      <div
                        className="hidden sm:block mt-6 mb-2 py-2 border-2 border-black cursor-pointer w-auto"
                        onClick={handleAddToCartFunc}
                      >
                        <p
                ...
                <div
                  className="description mx-4 mt-5 mb-2 py-2 text-base text-justify cursor-pointer w-auto tracking-widest"
